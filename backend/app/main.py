...
from app.controllers import user_bp, role_bp, permissions_bp, site_bp, search_results_bp, user_sites_bp, site_stats_bp, reviews_bp, category_bp, recommendations_bp
